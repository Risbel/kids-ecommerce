...
const Carousel = () => {
  ...
  return (
    <div className="relative">
      <div className="w-screen absolute top-1/2 px-2 md:hidden">
      ...
      <div
        id="content"
        className="z-10 flex px-5 gap-2 py-5 justify-start overflow-x-auto md:grid grid-cols-5 scrollbar-hide scroll-smooth"
      >
        <Image
